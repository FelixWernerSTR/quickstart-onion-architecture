...
public class WorkLogService implements WorkLogServiceI {
  ...
  public WorkLog editWorkLog(Long id, WorkLog workLog) throws BaseException {
    ...
    return workLogRepository.updateWorkLog(
        new WorkLog(id, workLog.getStartDate(), workLog.getTimeSpentInSeconds(), workLogFromBase.getAssociatedWorker(), workLog.getDescription()));
  }
