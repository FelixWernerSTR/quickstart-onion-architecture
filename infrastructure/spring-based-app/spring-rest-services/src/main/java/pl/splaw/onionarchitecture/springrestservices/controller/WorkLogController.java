...
public class WorkLogController {
   ...
   * @param workerService
   * @param domainToResponseMapper
   * @param requestsToDomainMapper
   */
  public WorkLogController(WorkLogServiceI workLogService, WorkerServiceI workerService, DomainToResponseMapper domainToResponseMapper,
      RequestsToDomainMapper requestsToDomainMapper) {
    super();
    this.workLogService = workLogService;
    this.workerService = workerService;
    this.domainToResponseMapper = domainToResponseMapper;
    this.requestsToDomainMapper = requestsToDomainMapper;
  }
